...
if (departmentName == null || departmentName.trim().isEmpty()) {
    response.sendRedirect("superadmin.jsp?error=No+department+selected");
    return;
}
...
try {
    ...
    if (rs.next()) {
        ...
        response.sendRedirect("superadmin.jsp?error=Department+not+found");
        return;
    }
    ...
    response.sendRedirect("superadmin.jsp?error=Database+error");
    return;
}
%>
    ...
    <div class="main-content">
        ...
        <div class="edit-form-container">
            <div class="form-header">
                <h3 class="form-title">Edit Department Information</h3>
                <button class="back-button" onclick="window.location.href='superadmin.jsp'">
                    <i class="fas fa-arrow-left"></i> Back to Dashboard
                </button>
            </div>
            
            <form id="editDepartmentForm" action="DepartmentUpdateServlet" method="post">
