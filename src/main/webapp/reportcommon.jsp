...
<%
    ...
    String dashboardPage = "superadmin.jsp"; // default
    if (userRole != null && userRole.equalsIgnoreCase("admin")) {
        dashboardPage = "admin.jsp";
    }
    ...
    if (userRole == null) userRole = "superadmin"; // fallback to superadmin if not set
    ...
    <div class="report-table-container">
        <% if (users.isEmpty()) { %>
            <div style="padding: 40px; text-align: center;">
                ...
                <p style="color: var(--gray);">No users found or no data for the selected period</p>
<a href="<%= dashboardPage %>" class="btn btn-primary" style="text-decoration:none;">
