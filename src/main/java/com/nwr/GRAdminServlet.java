...
@WebServlet("/generate-report-common")
public class GRAdminServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            try (PreparedStatement userPs = conn.prepareStatement(
                    "SELECT DISTINCT username FROM register_entries ORDER BY username")) {
            ...
            // Forward to JSP
            request.getRequestDispatcher("/reportcommon.jsp").forward(request, response);
